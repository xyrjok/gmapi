        ...
        if (rule) {
            try {
                ...
                <head>
                    ...
                    <title>查询结果</title>
                    <style>
                        .content-output{font-size:14px;font-weight:500;font-family:'Microsoft YaHei Bold','Microsoft YaHei',sans-serif;word-wrap:break-word;white-space:pre-wrap;margin:0}
                        @media(max-width:670px){.content-output{font-size:17px}}
                    </style>
                </head>
                <body>
